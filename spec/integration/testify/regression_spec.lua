...
describe("Integration: testify regression test", function()
  it(
    "file reports test discovery and execution for regression suite",
    function()
      -- ===== ARRANGE =====
      ...
      local position_id = vim.uv.cwd()
        .. "/tests/features/internal/testifysuites/regression_test.go"
