...
describe("Integration: diagnostics test", function()
  it(
    ...
    function()
      ...
      local position_id = vim.uv.cwd() .. "/tests/go/internal"
      ...
      local want = {
        results = {
          ...
          [path.normalize_path(
            vim.uv.cwd() .. "/tests/go/internal/nested/subpackage2/subpackage3"
          )] = {
            errors = {},
            status = "passed",
          },
          [path.normalize_path(vim.uv.cwd() .. "/tests/go/internal/notests")] = {
            errors = {},
            status = "skipped",
          },
          [path.normalize_path(vim.uv.cwd() .. "/tests/go/internal/packaging")] = {
            errors = {},
            status = "passed",
          },
          [path.normalize_path(vim.uv.cwd() .. "/tests/go/internal/positions")] = {
            errors = {},
            status = "passed",
          },
          [path.normalize_path(vim.uv.cwd() .. "/tests/go/internal/precision")] = {
            errors = {},
            status = "passed",
          },
          [path.normalize_path(
            vim.uv.cwd() .. "/tests/go/internal/query_duplicates"
          )] = {
            errors = {},
            status = "passed",
          },
          [path.normalize_path(vim.uv.cwd() .. "/tests/go/internal/singletest")] = {
            errors = {},
            status = "passed",
          },
          [path.normalize_path(
            vim.uv.cwd() .. "/tests/go/internal/specialchars"
          )] = {
            errors = {},
            status = "passed",
          },
